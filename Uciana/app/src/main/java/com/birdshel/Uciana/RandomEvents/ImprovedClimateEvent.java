...
public class ImprovedClimateEvent extends ClimateEvent implements RandomEvent {
    private final int OWN_COLONY = 0;
    private final int KNOWN_WORLD = 1;
    private final int UNKNOWN_WORLD = 2;

    /* compiled from: MyApplication */
    /* renamed from: com.birdshel.Uciana.RandomEvents.ImprovedClimateEvent$1 */
    /* loaded from: classes.dex */
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f1409a[Climate.BOG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1409a[Climate.METHANE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1409a[Climate.BOREAL.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1409a[Climate.PLAGUE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1409a[Climate.TROPICAL_OCEAN.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1409a[Climate.SENTIENT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f1409a[Climate.MOLTEN.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f1409a[Climate.RADIATED.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f1409a[Climate.CORROSIVE.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f1409a[Climate.BARREN.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f1409a[Climate.DESERT.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f1409a[Climate.TUNDRA.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f1409a[Climate.SWAMP.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f1409a[Climate.ARID.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f1409a[Climate.OCEAN.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f1409a[Climate.JUNGLE.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f1409a[Climate.GARDEN.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f1409a[Climate.TERRAN.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f1409a[Climate.ICE.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
        }
    }

    private Climate getBetterClimate(Climate climate) {
        switch (AnonymousClass1.f1409a[climate.ordinal()]) {
            case 8:
            case 9:
    ...
    public int execute(Game game) {
        return a(game, RandomEventType.IMPROVED_CLIMATE);
    }
    ...
    public Entity getMessage(MessageOverlay messageOverlay, int i, int i2, int i3, int i4) {
        ...
        Text text = new Text(0.0f, 0.0f, game.fonts.infoFont, game.getActivity().getString(R.string.improved_climate), new TextOptions(HorizontalAlign.CENTER), buffer);
        ...
        if (messageType == 0) {
            string = game.getActivity().getString(Functions.getResId("improved_climate_own_" + game.getCurrentPlayer(), R.string.class), new Object[]{name});
        } else if (messageType == 1) {
            string = game.getActivity().getString(Functions.getResId("improved_climate_known_" + game.getCurrentPlayer(), R.string.class), new Object[]{name});
        } else if (messageType != 2) {
            string = "";
        } else {
            string = game.getActivity().getString(Functions.getResId("improved_climate_unknown_" + game.getCurrentPlayer(), R.string.class));
        }
    ...
    public boolean initialize(Game game) {
        ...
        for (RandomEventData randomEventData : game.randomEvents.b(RandomEventType.IMPROVED_CLIMATE)) {
        ...
        for (StarSystem starSystem : game.galaxy.getStarSystems()) {
            for (SystemObject systemObject : starSystem.getSystemObjects()) {
                if (systemObject.isPlanet()) {
                    ...
                    if (!planet.getClimate().isSpecial() && planet.getClimate() != Climate.GAIA && !planet.getTerraformedClimate().isRareClimate()) {
        ...
        Climate betterClimate = getBetterClimate(planet2.getPreTerraformedClimate());
        Climate terraformedClimate = betterClimate.getTerraformedClimate();
        if (planet2.getResources().size() == 4 && Resources.climateHasResource(terraformedClimate)) {
            switch (AnonymousClass1.f1409a[terraformedClimate.ordinal()]) {
                case 1:
        ...
        Climate betterClimate2 = getBetterClimate(planet2.getClimate());
        game.gameSettings.setSetting(GameSettingsEnum.RANDOM_EVENTS_NEXT_DATA1, Integer.valueOf(c((int) point2.getX(), (int) point2.getY())));
        game.gameSettings.setSetting(GameSettingsEnum.RANDOM_EVENTS_NEXT_DATA2, Integer.valueOf(b(betterClimate, terraformedClimate)));
        game.gameSettings.setSetting(GameSettingsEnum.RANDOM_EVENTS_NEXT_DATA3, Integer.valueOf(betterClimate2.ordinal()));
        return true;
    }
}
