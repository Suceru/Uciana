...
public class NewDepositsFoundEvent implements RandomEvent {
    ...
    public Entity getMessage(MessageOverlay messageOverlay, int i, int i2, int i3, int i4) {
        ...
        if (messageType == 0) {
            string = game.getActivity().getString(Functions.getResId("new_mineral_deposits_own_" + game.getCurrentPlayer(), R.string.class), new Object[]{name});
        } else if (messageType == 1) {
            string = game.getActivity().getString(Functions.getResId("new_mineral_deposits_known_" + game.getCurrentPlayer(), R.string.class), new Object[]{name});
        } else if (messageType != 2) {
            string = "";
        } else {
            string = game.getActivity().getString(Functions.getResId("new_mineral_deposits_unknown_" + game.getCurrentPlayer(), R.string.class));
        }
    ...
    public boolean initialize(Game game) {
        ...
        for (RandomEventData randomEventData : game.randomEvents.b(RandomEventType.NEW_DEPOSITS_FOUND)) {
