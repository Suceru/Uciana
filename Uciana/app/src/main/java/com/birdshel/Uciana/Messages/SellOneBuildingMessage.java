...
public class SellOneBuildingMessage implements Message {
    ...
    public void set(MessageOverlay messageOverlay) {
        ...
        Text text = new Text(0.0f, 0.0f, game.fonts.infoFont, game.getActivity().getString(R.string.sell_one_building_message), new TextOptions(HorizontalAlign.CENTER), messageOverlay.getBuffer());
