...
public class ComputerVirusEvent implements RandomEvent {
    ...
    public int execute(Game game) {
        ...
        game.randomEvents.a(new RandomEventData(RandomEventType.COMPUTER_VIRUS, game.gameSettings.currentRandomEventData1(), game.gameSettings.currentRandomEventData2(), game.gameSettings.currentRandomEventData3()));
    ...
    public Entity getMessage(MessageOverlay messageOverlay, int i, int i2, int i3, int i4) {
        ...
        Text text = new Text(0.0f, 0.0f, game.fonts.infoFont, game.getActivity().getString(R.string.computer_virus), new TextOptions(HorizontalAlign.CENTER), buffer);
        ...
        if (z) {
            string = game.getActivity().getString(Functions.getResId("computer_virus_them_" + game.getCurrentPlayer(), R.string.class), new Object[]{Integer.valueOf(i3)});
        } else {
            string = game.getActivity().getString(Functions.getResId("computer_virus_others_" + game.getCurrentPlayer(), R.string.class));
        }
    ...
    public boolean initialize(Game game) {
        ...
        game.gameSettings.setSetting(GameSettingsEnum.RANDOM_EVENTS_NEXT_DATA2, Integer.valueOf(Functions.getRandom(100, 300) * (-1)));
