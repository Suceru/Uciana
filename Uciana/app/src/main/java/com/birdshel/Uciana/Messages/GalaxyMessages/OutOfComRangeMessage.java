...
public class OutOfComRangeMessage implements Message {
    ...
    public void set(MessageOverlay messageOverlay) {
        ...
        Text text = new Text(0.0f, 0.0f, game.fonts.infoFont, game.getActivity().getString(R.string.fleet_out_comm_range), new TextOptions(AutoWrap.WORDS, 1200.0f, HorizontalAlign.CENTER), messageOverlay.getBuffer());
