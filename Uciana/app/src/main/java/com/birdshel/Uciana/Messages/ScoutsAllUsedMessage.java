...
public class ScoutsAllUsedMessage implements Message {
    ...
    public void set(MessageOverlay messageOverlay) {
        ...
        Text text = new Text(0.0f, 0.0f, game.fonts.infoFont, game.getActivity().getString(R.string.scouts_all_used), new TextOptions(HorizontalAlign.CENTER), messageOverlay.getBuffer());
